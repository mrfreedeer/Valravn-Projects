...
void App::Startup()
{
	...
	float UI_SIZE_X = g_gameConfigBlackboard.GetValue("UI_SIZE_X", 1800.0f);
	float UI_CENTER_X = UI_SIZE_X * 0.5f;
	float UI_SIZE_Y = g_gameConfigBlackboard.GetValue("UI_SIZE_Y", 1800.0f);
	float UI_CENTER_Y = UI_SIZE_Y * 0.5f;
	float TEXT_CELL_HEIGHT = UI_SIZE_Y * 0.15f;
	...
	windowConfig.m_windowTitle = "Libra: SD1 - A8: Epilogue";
