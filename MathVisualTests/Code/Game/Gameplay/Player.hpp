...
public:
	...
	Vec3 const GetDeltaDisplacement() const;
	EulerAngles const GetDeltaOrientation() const;
private:
	void UpdateInput();
...
private:
	...
	Vec3 m_prevPosition = Vec3::ZERO;
	EulerAngles m_mouseDeltaAngle = EulerAngles::ZERO;
};