...
class RaycastVsOBB2Mode : public GameMode {
public:
	RaycastVsOBB2Mode(Game* pointerToGame, Vec2 const& cameraSize, Vec2 const& UICameraSize);
	~RaycastVsOBB2Mode();
...
private:
	...
	std::vector<Vertex_PCU> m_raycastVsBoxCollisionVerts;
